module NbaPlayers
  class Scraper
    def self.scrape_page(*)
      nokogiri_url = Nokogiri::HTML(open('https://www.washingtonpost.com/graphics/2017/sports/nba-top-100-players-2017/?noredirect=on&utm_term=.adcc13ae7e38'))
      ...
      [players_neutral, players_up, players_down]
    end
  end
end
